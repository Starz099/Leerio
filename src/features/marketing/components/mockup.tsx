...
export default function Mockup() {
  ...
  // Auto-cycle through modes every 2 seconds
  useEffect(() => {
  ...
  return (
    <section id="features" className="relative overflow-hidden py-0">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        {/* App Mockup */}
        <div className="relative mb-12">
          {/* macOS Window */}
          <div className="border-border/40 bg-muted/40 overflow-hidden rounded-xl border shadow-xl">
            {/* Window Header */}
            <div className="bg-muted/80 border-border/40 flex flex-wrap items-center justify-between gap-2 border-b px-4 py-3 sm:gap-3">
                      ...
                      <div className="mb-6 flex-1 space-y-4 overflow-y-auto">
                        ...
                        <div className="bg-muted/20 rounded-lg p-4">
                          <p className="text-foreground text-sm leading-relaxed">
                            ...
                            methodologies and presents significant findings in
                            the field...
                          </p>
                        </div>
                      </div>
